...
class DataProcessor:
    ...
    def vehicleStatusCallback(self,msg):
        if msg.drivemode == 0:
            ...
            self.leaf_driver_mode = "\u001b[31mUNDEF\u001b[0m"
    ...
    def getRightOusterMsg(self):
        try:
            ...
            self.ouster_right_ok = "\u001b[31mERR\u001b[0m"
