...
#include "autoware_msgs/LaneArray.h" // TODO
...
private:
  ...
  autoware_msgs::LaneArray output_lane_array_; // TODO

  // initializer
  void initPubSub();

  // functions
  void createLaneWaypoint(const std::string& file_path, autoware_msgs::Lane* lane); // TODO
  void createLaneArray(const std::vector<std::string>& paths, autoware_msgs::LaneArray* lane_array); // TODO

  FileFormat checkFileFormat(const char* filename);
  bool verifyFileConsistency(const char* filename);
  void loadWaypointsForVer1(const char* filename, std::vector<autoware_msgs::Waypoint>* wps); // TODO
  void parseWaypointForVer1(const std::string& line, autoware_msgs::Waypoint* wp); // TODO
  void loadWaypointsForVer2(const char* filename, std::vector<autoware_msgs::Waypoint>* wps); // TODO
  void parseWaypointForVer2(const std::string& line, autoware_msgs::Waypoint* wp); // TODO
  void loadWaypointsForVer3(const char* filename, std::vector<autoware_msgs::Waypoint>* wps); // TODO
