...
def callback_fuction(message):
    if (1 - message.drivemode + buf == 0):
        playsound("/home/zsoldos/szenergy_ws/src/autonomous_sound/src/start_trimmed.mp3")
        global buf
        buf = 1
    elif (2 - message.drivemode - buf == 1):
        playsound("/home/zsoldos/szenergy_ws/src/autonomous_sound/src/stop_trimmed.mp3")
        global buf
        buf = 0
    else: None
